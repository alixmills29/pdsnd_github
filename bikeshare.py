...
def get_filters():
    ...
    """
    print('Hello! Welcome to the bikshare statistics system. Let\'s explore some US bikeshare data!')
...
def main():
    while True:
        ...
        restart = input('\nWould you like to restart the bikeshare statistics program? Please enter yes or no.\n')
